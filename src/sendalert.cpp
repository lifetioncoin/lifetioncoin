...
2. run lifetioncoind with -printalert or -sendalert like this:
   /path/to/lifetioncoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cointobanks.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/LifetionCoin Core:0.12.0.58/"));
