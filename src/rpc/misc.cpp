...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total lifetioncoin balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized lifetioncoin balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "lifetioncoin|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "lifetioncoin")
            + HelpExampleRpc("debug", "lifetioncoin,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"lifetioncoinaddress\"\n"
            "\nReturn information about the given lifetioncoin address.\n"
            "\nArguments:\n"
            "1. \"lifetioncoinaddress\"     (string, required) The lifetioncoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"lifetioncoinaddress\", (string) The lifetioncoin address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"")
            + HelpExampleRpc("validateaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: LifetionCoin address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are lifetioncoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) lifetioncoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"lifetioncoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"lifetioncoinaddress\"  (string, required) The lifetioncoin address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"]}")
        );
