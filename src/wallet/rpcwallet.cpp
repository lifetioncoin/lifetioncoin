...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new LifetionCoin address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"lifetioncoinaddress\"    (string) The new lifetioncoin address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current LifetionCoin address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"lifetioncoinaddress\"   (string) The account lifetioncoin address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new LifetionCoin address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"lifetioncoinaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"lifetioncoinaddress\"  (string, required) The lifetioncoin address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\", \"tabby\"")
        );
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid LifetionCoin address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"lifetioncoinaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"lifetioncoinaddress\"  (string, required) The lifetioncoin address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"")
            + HelpExampleRpc("getaccount", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"")
        );
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"lifetioncoinaddress\"  (string) a lifetioncoin address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            "sendtoaddress \"lifetioncoinaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is use_ps )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"lifetioncoinaddress\" (string, required) The lifetioncoin address to send to.\n"
            ...
            "                             The recipient will receive less amount of LifetionCoin than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"lifetioncoinaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"lifetioncoinaddress\",     (string) The lifetioncoin address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"lifetioncoinaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"lifetioncoinaddress\"  (string, required) The lifetioncoin address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "getreceivedbyaddress \"lifetioncoinaddress\" ( minconf addlockconf )\n"
            "\nReturns the total amount received by the given lifetioncoinaddress in transactions with specified minimum number of confirmations.\n"
            "\nArguments:\n"
            "1. \"lifetioncoinaddress\"  (string, required) The lifetioncoin address for transactions.\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\", 6")
       );

    LOCK2(cs_main, pwalletMain->cs_wallet);

    // LifetionCoin address
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tolifetioncoinaddress\" amount ( minconf addlockconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a lifetioncoin address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"    (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"tolifetioncoinaddress\"  (string, required) The lifetioncoin address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The lifetioncoin address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less lifetioncoins than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\\\":0.01,\\\"LiX5EfNzmy8iV2qAUkpEJHEzp8g7VPcJED\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\\\":0.01,\\\"LiX5EfNzmy8iV2qAUkpEJHEzp8g7VPcJED\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\\\":0.01,\\\"LiX5EfNzmy8iV2qAUkpEJHEzp8g7VPcJED\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid LifetionCoin address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a LifetionCoin address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of lifetioncoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) lifetioncoin address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"lifetioncoinaddress\"  (string) A lifetioncoin address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"lifetioncoinaddress\",  (string) The lifetioncoin address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"lifetioncoinaddress\",  (string) The lifetioncoin address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"lifetioncoinaddress\",      (string) The lifetioncoin address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending lifetioncoins\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending lifetioncoin\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"lifetioncoinaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "Wallet encrypted; LifetionCoin Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending lifetioncoins.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of lifetioncoin addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) lifetioncoin address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the lifetioncoin address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\\\",\\\"LiX5EfNzmy8iV2qAUkpEJHEzp8g7VPcJED\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"LQ3AvGVnGBPDdKxaho8ccGocriBFi2k3NR\\\",\\\"LiX5EfNzmy8iV2qAUkpEJHEzp8g7VPcJED\\\"]\"")
        );
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid LifetionCoin address: ")+input.get_str());
            if (setAddress.count(address))
