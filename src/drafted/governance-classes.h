 ...
 *
 *   // network
 *   CLifetionCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cointobanks.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLifetionCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CLifetionCoinNetwork(UniValue objIn)
    {
...
// // can be under: LifetionCoinNetwork
// //   -- signature requirements : Key1(User)
// class CLifetionCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == LifetionCoinNetwork);
//     // }
