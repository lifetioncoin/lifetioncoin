...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LifetionCoinNetwork") type = LifetionCoinNetwork;
    if(strType == "LifetionCoinNetworkVariable") type = LifetionCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LifetionCoinNetwork) s = "LifetionCoinNetwork";
    if(type == LifetionCoinNetworkVariable) s = "LifetionCoinNetworkVariable";
