...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("LifetionCoin Core lifetioncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lifetioncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lifetioncoin transaction") + "\n" +
              "  lifetioncoin-tx [options] -create [commands]   " + _("Create hex-encoded lifetioncoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lifetioncoin transaction
