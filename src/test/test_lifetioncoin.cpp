...
#define BOOST_TEST_MODULE LifetionCoin Test Suite

#include "test_lifetioncoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_lifetioncoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
