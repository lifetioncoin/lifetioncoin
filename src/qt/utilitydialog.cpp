    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("LifetionCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About LifetionCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  lifetioncoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the LifetionCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LTP, 0.1 LTP, 1 LTP and 10 LTP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cointobanks.atlassian.net/wiki/display/DOC/PrivateSend\">https://cointobanks.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("LifetionCoin Core is shutting down...") + "<br /><br />" +
