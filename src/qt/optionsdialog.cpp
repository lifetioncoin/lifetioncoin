    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LTP-light"), QVariant("light"));
    ui->theme->addItem(QString("LTP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LTP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LTP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LTP-traditional"), QVariant("trad"));
