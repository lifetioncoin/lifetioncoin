    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("LifetionCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LifetionCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lifetioncoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About LifetionCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about LifetionCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LifetionCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LifetionCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LifetionCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a lifetioncoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LifetionCoin Core help message to get a list with possible LifetionCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("LifetionCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LifetionCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("LifetionCoin Core"); // default title
    ...
    // Append title to "LifetionCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
