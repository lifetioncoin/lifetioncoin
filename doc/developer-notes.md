...
LifetionCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 7977.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9555 for connections and services them.
...
However, in open source software such as LifetionCoin Core, where everyone uses
...
pay attention to for reviewers of LifetionCoin Core code.

General LifetionCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: LifetionCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
