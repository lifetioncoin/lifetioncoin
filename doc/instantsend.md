...
This mechanism has been integrated into Bitcore-Node-LifetionCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cointobanks/insight-api-lifetioncoin#web-socket-api](https://github.com/cointobanks/insight-api-lifetioncoin#web-socket-api)
* API: [https://github.com/cointobanks/insight-api-lifetioncoin#instantsend-transactions](https://github.com/cointobanks/insight-api-lifetioncoin#instantsend-transactions)
...
By default, the LifetionCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LifetionCoin Core daemon:
